...
<body>
    ...
    <div class="page-header">
        ...
        <ul class="navbar-nav">
            ...
            <li>
                <a href="https://thi-vua-lay-tot.github.io/blog" title="Các thông báo/bài đăng quan trọng của TVLT">Thông báo/Tin tức</a>
            </li>
            <li>
            ...
            <li>
                <div class="dropdown">
                    <a class="dropbtn" href="https://thivualaytot.github.io/webs" title="Social media links">Xã hội
                      <i class="bx bx-caret-down"></i>
                    </a>
                    <div class="dropdown-content">
                        <a href="https://thivualaytot.github.io/webs#social">Các tài khoản MXH của TungJohn</a>
                        <a href="https://thivualaytot.github.io/webs#chat">Các đoạn chat của Thí Vua Lấy Tốt</a>
                        <a href="https://thivualaytot.github.io/webs#group">Các nhóm/CLB/máy chủ của Thí Vua Lấy Tốt</a>
                    </div>
                </div>
            </li>
            <li>
            ...
            <li>
                <div class="dropdown">
                    <a class="dropbtn" href="https://thivualaytot.github.io/list" title="Các danh sách/bảng quan trọng">Danh sách/Tài liệu
                      <i class="bx bx-caret-down"></i>
                    </a>
                    <div class="dropdown-content">
                        <a href="https://thivualaytot.github.io/tournament-history">Danh sách tổng hợp các giải đấu</a>
            ...
            <li>
                <div class="dropdown">
                    <a class="dropbtn" href="https://thivualaytot.github.io/team" title="Ban cán sự của Thí Vua Lấy Tốt">Leaders
                      <i class="bx bx-caret-down"></i>
                    </a>
                    <div class="dropdown-content">
                        <a href="https://thivualaytot.github.io/team#admins">Administrators/Các Quản trị viên</a>
                        <a href="https://thivualaytot.github.io/team#mods">Moderators/Các điều hành viên</a>
                        <a href="https://thivualaytot.github.io/team#sponsors">Các nhà tài trợ/hợp tác với giải</a>
                    </div>
                </div>
            </li>
        </ul>
...
footer_style = """
    ...
    <div class="footer-container">
        <div>
            ...
            <p><a href="https://thi-vua-lay-tot.github.io/blog" title="Các bài Blog quan trọng của TVLT">Các thông báo & tin tức</a></p>
            ...
            <p><a href="https://thivualaytot.github.io/list" title="Các danh sách/bảng quan trọng">Danh sách/Tài liệu</a></p>
        ...
        <div>
            ...
            <div class="button">
                ...
                <a href="https://lichess.org/team/thi-vua-lay-tot-tungjohn-playing-chess" target="_blank" title="Đội Thí Vua Lấy Tốt trên Lichess"><img src="./images/lichesslogo.png"></a>
                <a href="https://facebook.com/TungJohn2005" target="_blank" title="Trang Facebook của TungJohn Playing Chess"><i class="bx bxl-facebook"></i></a>
...
def generate_h1_tag(filename):
    ...
    <h2 align="center">Bạn có thể xem Top các kỳ thủ đạt giải {title} <a href="https://thivualaytot.github.io/tournament-history/top/{title}">Ở đây</a>.</h2>
