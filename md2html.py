...
<body>
    ...
    <div class="page-header">
        ...
        <ul class="navbar-nav">
            ...
            <li>
                <a href="https://thivualaytot.github.io/game" title="Các trò chơi đơn giản">MiniGames</a>
            </li>
            <li>
                <div class="dropdown">
                    <a class="dropbtn" href="./list" title="Các danh sách/bảng quan trọng">Danh sách/Tài liệu
            ...
            <li>
                <a href="https://thivualaytot.github.io/team" title="Ban cán sự của TVLT">Leaders</a>
            </li>
        </ul>
        <div>
            <label class="mode">
